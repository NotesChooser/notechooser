class Measure { //class for Measure object
    ...
    show(SMuFLdictionary, musFont) { //draws the measure to the screen based on the arguments
        ...
        fill(0,0,0);
        const encodedText = encode(`(staff5LinesWide)(barlineSingle)(staff5LinesNarrow)(${this.clef})${this.timeSignature.unicodepoint(SMuFLdictionary)}(staff5LinesWide)      (staff5LinesWide)      (staff5LinesWide)      (staff5LinesWide)      (staff5LinesWide)     (barlineHeavy)`, SMuFLdictionary)
